...
import { CINDERELLA_EPISODE_1 } from './data/storyData';
        ...
        {currentNode.dialogue && (
          <div className="mb-3">
            <DialogueBox
              ...
              avatar={currentNode.character?.id === 'prince' ? '/assets/characters/prince_cape.png' : '/assets/characters/cinderella_cold.png'}
